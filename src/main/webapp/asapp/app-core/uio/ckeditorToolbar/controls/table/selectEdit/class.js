define([ 'as' ], function(as) {
	...
	function Tree(context, path, template, container, rootEntryBuilder, branchBuilder) {
		Class.call(this, context, path, template, container, rootEntryBuilder, branchBuilder);
	}
